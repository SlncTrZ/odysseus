                    ...
                    async for chunk in stream_llm_with_fallback(
                        ...
                        if chunk.startswith("data: ") and not chunk.startswith(
                            ...
                            try:
                                ...
                                elif data.get("type") == "truncated":
                                    # Response was cut off (token limit / connection lost).
                                    # Forward the event to the frontend so it can show a
                                    # warning and Continue button.
                                    yield chunk
